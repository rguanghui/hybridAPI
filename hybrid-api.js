(function (global, factory) {
  ...
  !function(e,n){"object"==typeof exports&&"undefined"!=typeof module?n(exports):"function"==typeof define&&define.amd?define(["exports"],n):n(e.bridgeProtocol=e.bridgeProtocol||{})}(commonjsGlobal,function(e){"use strict";var n=function(){var e=navigator.userAgent||navigator.vendor;return/windows phone/i.test(e)?"Windows Phone":/android/i.test(e)?"Android":/iPad|iPhone|iPod/.test(e)&&!window.MSStream?"iOS":"Unknown"},t=function(e){var n=document.createEvent("Events");n.initEvent("WebViewJavascriptBridgeReady"),n.bridge=e,document.dispatchEvent(n)},i={},r="elmscheme",a="__ELM_QUEUE_MESSAGE__",o="elemejsbridge",d="_handler",c="_interface",s=n(),l={},u=void 0,f=function(){u=document.createElement("iframe"),u.style.display="none","iOS"===s&&(u.src=r+"://"+a),document.documentElement.appendChild(u)},v=1,p=[],w=function(e,n,t){if(n){var d="cb_"+v++ +"_"+(new Date).getTime();i[d]=n,e.callbackId=d}p.push(e);var c=JSON.stringify(p);"iOS"===s?u.src=r+"://"+a:(u.src=o+"://return/"+t+"/"+encodeURIComponent(c),p=[])},g=function(){var e=JSON.stringify(p);return p=[],e},h=function(e,n){l[e]=n},m=function(e){return l[e]},E=function(e,n,t){w({handlerName:e,data:n},t,d)},b=function(e,n,t,i){var r={obj:e,method:n};"undefined"!=typeof t&&null!==t&&(r.data=t),w(r,i,c)},_="_response",y=function(e){var n=JSON.parse(e),t=void 0;if(n.responseId)t=i[n.responseId],"function"==typeof t&&t(n.responseData||n.data),delete i[n.responseId];else{if(n.callbackId){var r=n.callbackId;t=function(e){w({responseId:r,data:e},null,_)}}var a=WebViewJavascriptBridge._messageHandler;n.handlerName&&(a=m(n.handlerName));try{a(n.data,t)}catch(e){"undefined"!=typeof console&&console.log("WebViewJavascriptBridge: WARNING: javascript handler threw.",n,e)}}},J=[],S=function(e){J?J.push(e):y(e)},j=!1,I=function(e){if(j)throw new Error("WebViewJavascriptBridge.init called twice");if(window.WebViewJavascriptBridge&&(window.WebViewJavascriptBridge._messageHandler=e,j=!0,J)){for(var n=0;n<J.length;n++)y(J[n]);J=null}},W=function(e,n){var t=window[e]={},i=function(n){n=n.replace(new RegExp(":","g"),""),t[n]=function(){var t=arguments.length;if(t>2)throw new Error("arguments Error");var i=arguments[0]||null,r=arguments[1]||null;1===t&&"function"==typeof i&&(r=i,i=null),b(e,n,i,r)}};(n||[]).forEach(i)},N=function(){var e=document.createEvent("Events");e.initEvent("WebViewJavascriptBridgeInjectFinishedReady"),document.dispatchEvent(e)},O=function(){};O.init=I,O.inject=W,O.injectEvent=N,O.registerHandler=h,O.callHandler=E;var B=n();"iOS"===B?(O._fetchQueue=g,O._handleMessageFromObjC=S):"Android"===B?O._handleMessageFromNative=S:console.warn("Error: "+B+" is not supported."),window.WebViewJavascriptBridge=O,f(),t(O),I(),e.inject=W,e.registerHandler=h,e.callHandler=E,e.callObjectMethod=b});
  });
